...
print('Пример кода с использованием numpy:\nвыполнение различных математических операций.\n')

# Создаем массив чисел от 1 до 10
arr = np.arange(1, 11)
print("Массив чисел:", arr)

# Сложение 5 ко всем элементам
added = arr + 5
print("После добавления 5:", added)

# Умножение на 2
multiplied = arr * 2
print("После умножения на 2:", multiplied)

# Возведение в квадрат
squared = arr ** 2
print("После возведения в квадрат:", squared)
